...
function Editprofile() {
  ...
  return (
    <>
    <button onClick={()=>setoffcanvas(true)} className='flex px-4 py-3 font-bold border border-blue-200 text-blue-600'><FaRegEdit className='mt-1 me-2'/>Edit
          </button>
          ...
          {offcanvas && <div>
            ...
            <div className='bg-white h-full w-90 z-50 fixed top-0 left-0'> 
                ...
                <div className='flex ms-45 mt-10 gap-5'>
